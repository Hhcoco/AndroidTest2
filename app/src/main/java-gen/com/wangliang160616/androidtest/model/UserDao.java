...
public class UserDao extends AbstractDao<User, Long> {
    ...
    public static class Properties {
        ...
        public final static Property UserSex = new Property(4, String.class, "userSex", false, "userSex");
        public final static Property UserAge = new Property(5, Integer.class, "userAge", false, "userAge");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USER\" (" + //
                ...
                "\"userSex\" TEXT," + // 4: userSex
                "\"userAge\" INTEGER);"); // 5: userAge
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5) // userAge
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setUserAge(cursor.isNull(offset + 5) ? null : cursor.getInt(offset + 5));
     }
